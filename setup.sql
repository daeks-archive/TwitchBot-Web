...
--
ALTER TABLE `logs`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1302021;
--
-- AUTO_INCREMENT für Tabelle `log_plugins`
--
ALTER TABLE `log_plugins`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13848550;
--
...
--
ALTER TABLE `plugin_credits`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12494;
--
-- AUTO_INCREMENT für Tabelle `plugin_filters`
--
ALTER TABLE `plugin_filters`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8158;
--
...
--
ALTER TABLE `plugin_ranks`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12552;
--
...
INSERT INTO `users` (`ID`, `NAME`, `OAUTH`, `EMAIL`, `LOGO`, `BANNER`, `LEVEL`, `SCOPE`, `ENABLED`, `INSERTED`, `INSERTBY`, `UPDATED`, `UPDATEBY`) VALUES
(0, 'system', '', NULL, NULL, NULL, NULL, NULL, 1, '2016-04-25 16:55:28', NULL, '2016-04-25 16:55:36', NULL);

INSERT INTO `bots` (`ID`, `USERID`, `NAME`, `LOGO`, `BANNER`, `OAUTH`, `PORT`, `COLOR`, `OWNER`, `ENABLED`, `AUTOSTART`, `INSERTED`, `INSERTBY`, `UPDATED`, `UPDATEBY`) VALUES
(0, 0, 'GLOBAL', NULL, NULL, '', NULL, '', '', 0, 0, '2016-04-18 15:45:59', NULL, '2016-05-18 07:17:18', NULL);

INSERT INTO `channels` (`ID`, `BOTID`, `NAME`, `LOGO`, `BANNER`, `ENABLED`, `INSERTED`, `INSERTBY`, `UPDATED`, `UPDATEBY`) VALUES
(0, 0, 'GLOBAL', NULL, NULL, 0, '2016-04-18 15:48:25', NULL, '2016-04-18 16:26:57', NULL);

INSERT INTO `commands` (`ID`, `BOTID`, `CHANNELID`, `PLUGINID`, `COMMANDID`, `NAME`, `VALUE`, `LEVEL`, `ENABLED`, `INSERTED`, `INSERTBY`, `UPDATED`, `UPDATEBY`) VALUES
(0, 0, 0, 0, 0, 'GLOBAL', '', NULL, 1, '2016-04-23 11:35:41', NULL, '2016-04-23 11:35:49', NULL);

INSERT INTO `plugins` (`ID`, `BOTID`, `CHANNELID`, `NAME`, `ENABLED`, `POSITION`, `LEVEL`, `INSERTED`, `UPDATED`, `INSERTBY`, `UPDATEBY`) VALUES
(0, 0, 0, 'GLOBAL', 0, 0, NULL, '2016-04-18 16:02:07', '2016-04-18 16:27:18', NULL, NULL);
